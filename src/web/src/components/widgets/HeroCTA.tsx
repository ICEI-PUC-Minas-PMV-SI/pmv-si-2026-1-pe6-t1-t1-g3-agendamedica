      ...
      <div>
        ...
        <h2
          ...
          dangerouslySetInnerHTML={{
            __html:
              'Pronta para cuidar da sua <em>saúde hoje</em>?<br/>Agende em menos de <em>60 segundos</em>.',
          }}
        />
        <p className="hero-sub">
          Escolha especialidade, horário e a clínica mais perto de você. Você recebe confirmação
          automática e lembretes por e-mail e push.
        </p>
