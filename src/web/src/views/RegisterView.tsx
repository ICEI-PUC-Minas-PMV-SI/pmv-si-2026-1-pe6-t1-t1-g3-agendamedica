...
interface RegisterViewProps {
    ...
    onGoLogin: () => void;
    mode: "patient" | "professional"; // Nova prop necessária
}
        ...
        <div className="unauth-wrap">
            <div style={{ width: "100%", maxWidth: 400, margin: "0 auto" }}>
                ...
                <section className="card">
                    {error && <div className="alert alert-danger" style={{marginBottom: 16, color: 'red'}}>{error}</div>}
